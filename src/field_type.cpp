...
const field_type_str_id fd_fire( "fd_fire"_id );
const field_type_str_id fd_blood( "fd_blood"_id );
const field_type_str_id fd_bile( "fd_bile"_id );
const field_type_str_id fd_extinguisher( "fd_extinguisher"_id );
const field_type_str_id fd_gibs_flesh( "fd_gibs_flesh"_id );
const field_type_str_id fd_gibs_veggy( "fd_gibs_veggy"_id );
const field_type_str_id fd_web( "fd_web"_id );
const field_type_str_id fd_slime( "fd_slime"_id );
const field_type_str_id fd_acid( "fd_acid"_id );
const field_type_str_id fd_sap( "fd_sap"_id );
const field_type_str_id fd_sludge( "fd_sludge"_id );
const field_type_str_id fd_smoke( "fd_smoke"_id );
const field_type_str_id fd_toxic_gas( "fd_toxic_gas"_id );
const field_type_str_id fd_tear_gas( "fd_tear_gas"_id );
const field_type_str_id fd_nuke_gas( "fd_nuke_gas"_id );
const field_type_str_id fd_gas_vent( "fd_gas_vent"_id );
const field_type_str_id fd_fire_vent( "fd_fire_vent"_id );
const field_type_str_id fd_flame_burst( "fd_flame_burst"_id );
const field_type_str_id fd_electricity( "fd_electricity"_id );
const field_type_str_id fd_fatigue( "fd_fatigue"_id );
const field_type_str_id fd_push_items( "fd_push_items"_id );
const field_type_str_id fd_shock_vent( "fd_shock_vent"_id );
const field_type_str_id fd_acid_vent( "fd_acid_vent"_id );
const field_type_str_id fd_plasma( "fd_plasma"_id );
const field_type_str_id fd_laser( "fd_laser"_id );
const field_type_str_id fd_dazzling( "fd_dazzling"_id );
const field_type_str_id fd_blood_veggy( "fd_blood_veggy"_id );
const field_type_str_id fd_blood_insect( "fd_blood_insect"_id );
const field_type_str_id fd_blood_invertebrate( "fd_blood_invertebrate"_id );
const field_type_str_id fd_gibs_insect( "fd_gibs_insect"_id );
const field_type_str_id fd_gibs_invertebrate( "fd_gibs_invertebrate"_id );
const field_type_str_id fd_bees( "fd_bees"_id );
const field_type_str_id fd_incendiary( "fd_incendiary"_id );
const field_type_str_id fd_relax_gas( "fd_relax_gas"_id );
const field_type_str_id fd_fungal_haze( "fd_fungal_haze"_id );
...
const field_type_str_id fd_fungicidal_gas( "fd_fungicidal_gas"_id );
const field_type_str_id fd_insecticidal_gas( "fd_insecticidal_gas"_id );
const field_type_str_id fd_smoke_vent( "fd_smoke_vent"_id );
const field_type_str_id fd_tindalos_rift( "fd_tindalos_rift"_id );
    ...
    for( const JsonObject jao : jo.get_array( "intensity_levels" ) ) {
        ...
        if( jao.has_array( "effects" ) ) {
            for( const JsonObject joe : jao.get_array( "effects" ) ) {
                ...
                optional( joe, was_loaded, "body_part", fe.bp, bodypart_str_id( "bp_null"_id ) );
