...
mission_type_id mission_type::from_legacy( int old_id )
{
    static const std::vector<mission_type_id> old_id_vec = {{
            mission_type_id( "MISSION_NULL"_id ),
            mission_type_id( "MISSION_GET_ANTIBIOTICS"_id ),
            mission_type_id( "MISSION_GET_SOFTWARE"_id ),
            mission_type_id( "MISSION_GET_ZOMBIE_BLOOD_ANAL"_id ),
            mission_type_id( "MISSION_RESCUE_DOG"_id ),
            mission_type_id( "MISSION_KILL_ZOMBIE_MOM"_id ),
            mission_type_id( "MISSION_REACH_SAFETY"_id ),
            mission_type_id( "MISSION_GET_FLAG"_id ),
            mission_type_id( "MISSION_GET_BLACK_BOX"_id ),
            mission_type_id( "MISSION_GET_BLACK_BOX_TRANSCRIPT"_id ),
            mission_type_id( "MISSION_EXPLORE_SARCOPHAGUS"_id ),
            mission_type_id( "MISSION_GET_RELIC"_id ),
            mission_type_id( "MISSION_RECOVER_PRIEST_DIARY"_id ),
            mission_type_id( "MISSION_INVESTIGATE_CULT"_id ),
            mission_type_id( "MISSION_INVESTIGATE_PRISON_VISIONARY"_id ),
            mission_type_id( "MISSION_GET_RECORD_WEATHER"_id ),
            mission_type_id( "MISSION_GET_RECORD_PATIENT"_id ),
            mission_type_id( "MISSION_REACH_FEMA_CAMP"_id ),
            mission_type_id( "MISSION_REACH_FARM_HOUSE"_id ),
            mission_type_id( "MISSION_GET_RECORD_ACCOUNTING"_id ),
            mission_type_id( "MISSION_GET_SAFE_BOX"_id ),
            mission_type_id( "MISSION_GET_DEPUTY_BADGE"_id ),
            mission_type_id( "MISSION_KILL_JABBERWOCK"_id ),
            mission_type_id( "MISSION_KILL_100_Z"_id ),
            mission_type_id( "MISSION_KILL_HORDE_MASTER"_id ),
            mission_type_id( "MISSION_RECRUIT_TRACKER"_id ),
            mission_type_id( "MISSION_JOIN_TRACKER"_id ),
            mission_type_id( "MISSION_FREE_MERCHANTS_EVAC_1"_id ),
            mission_type_id( "MISSION_FREE_MERCHANTS_EVAC_2"_id ),
            mission_type_id( "MISSION_FREE_MERCHANTS_EVAC_4"_id ),
            mission_type_id( "MISSION_OLD_GUARD_REP_1"_id ),
            mission_type_id( "MISSION_OLD_GUARD_REP_2"_id ),
            mission_type_id( "MISSION_OLD_GUARD_REP_3"_id ),
            mission_type_id( "MISSION_OLD_GUARD_REP_4"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_1"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_2"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_COMMO_1"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_COMMO_2"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_COMMO_3"_id ),
            mission_type_id( "MISSION_OLD_GUARD_NEC_COMMO_4"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_1"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_2"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_3"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_4"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_5"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_6"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_7"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_8"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_9"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_10"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_11"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_12"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_13"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_14"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_15"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_16"_id ),
            mission_type_id( "MISSION_RANCH_FOREMAN_17"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_1"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_2"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_3"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_4"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_5"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_6"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_7"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_8"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_9"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_10"_id ),
            mission_type_id( "MISSION_RANCH_NURSE_11"_id ),
            mission_type_id( "MISSION_RANCH_SCAVENGER_1"_id ),
            mission_type_id( "MISSION_RANCH_SCAVENGER_2"_id ),
            mission_type_id( "MISSION_RANCH_SCAVENGER_3"_id ),
            mission_type_id( "MISSION_RANCH_SCAVENGER_4"_id ),
            mission_type_id( "MISSION_RANCH_BARTENDER_1"_id ),
            mission_type_id( "MISSION_RANCH_BARTENDER_2"_id ),
            mission_type_id( "MISSION_RANCH_BARTENDER_3"_id ),
            mission_type_id( "MISSION_RANCH_BARTENDER_4"_id ),
            mission_type_id( "MISSION_RANCH_BARTENDER_5"_id ),
            mission_type_id( "MISSION_FREE_MERCHANTS_EVAC_3"_id ),
    ...
    return mission_type_id( "MISSION_NULL"_id );
}
