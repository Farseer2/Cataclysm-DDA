...
static const trait_id trait_SMELLY( "SMELLY"_id );
static const trait_id trait_WEAKSCENT( "WEAKSCENT"_id );
static const trait_id trait_XS( "XS"_id );
static const trait_id trait_XXXL( "XXXL"_id );
        ...
        switch( sel ) {
            case 1:
                ...
                mvwprintz( w_description, point_zero, COL_STAT_NEUTRAL, _( "Base HP: %d" ),
                           u.get_part_hp_max( bodypart_id( "head"_id ) ) );
