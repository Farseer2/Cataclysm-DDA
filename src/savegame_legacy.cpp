...
void player_activity::deserialize_legacy_type( int legacy_type, activity_id &dest )
{
    static const std::vector< activity_id > legacy_map = {
        activity_id::NULL_ID(),
        activity_id( "ACT_RELOAD"_id ),
        activity_id( "ACT_READ"_id ),
        activity_id( "ACT_GAME"_id ),
        activity_id( "ACT_WAIT"_id ),
        activity_id::NULL_ID(), // ACT_CRAFT is an actor now
        activity_id::NULL_ID(), // ACT_LONGCRAFT is deprecated
        activity_id( "ACT_DISASSEMBLE"_id ),
        activity_id( "ACT_BUTCHER"_id ),
        activity_id( "ACT_LONGSALVAGE"_id ),
        activity_id( "ACT_FORAGE"_id ),
        activity_id( "ACT_BUILD"_id ),
        activity_id( "ACT_VEHICLE"_id ),
        activity_id::NULL_ID(), // ACT_REFILL_VEHICLE is deprecated
        activity_id( "ACT_TRAIN"_id ),
        activity_id( "ACT_WAIT_WEATHER"_id ),
        activity_id( "ACT_FIRSTAID"_id ),
        activity_id( "ACT_FISH"_id ),
        activity_id( "ACT_PICKAXE"_id ),
        activity_id( "ACT_BURROW"_id ),
        activity_id( "ACT_PULP"_id ),
        activity_id( "ACT_VIBE"_id ),
        ...
        activity_id( "ACT_PICKUP"_id ),
        activity_id( "ACT_MOVE_ITEMS"_id ),
        activity_id( "ACT_ADV_INVENTORY"_id ),
        activity_id( "ACT_ARMOR_LAYERS"_id ),
        activity_id( "ACT_START_FIRE"_id ),
        activity_id( "ACT_OPEN_GATE"_id ),
        activity_id( "ACT_FILL_LIQUID"_id ),
        activity_id( "ACT_HOTWIRE_CAR"_id ),
        activity_id( "ACT_AIM"_id ),
        activity_id( "ACT_ATM"_id ),
        activity_id( "ACT_START_ENGINES"_id ),
        activity_id( "ACT_OXYTORCH"_id ),
        activity_id( "ACT_CRACKING"_id ),
        activity_id( "ACT_REPAIR_ITEM"_id ),
        activity_id( "ACT_MEND_ITEM"_id ),
        activity_id( "ACT_GUNMOD_ADD"_id ),
        activity_id( "ACT_WAIT_NPC"_id ),
        activity_id( "ACT_CLEAR_RUBBLE"_id ),
        activity_id( "ACT_MEDITATE"_id ),
